...
| [recovery.md](recovery.md) | Durability posture: state inventory, snapshot/replica schedule, per-disaster restore steps, RPO/RTO, monthly restore drill, hourly snapshot-age alarm, pool-loss recv, offsite-age alarm |
...
| [review-guides/](review-guides/) | Agent review prompts. Zig idiom, 0.16, practices, abstractions, SIMD, and net-send guides target an unrelated game-server of the same name and skip this tree; [zig-src-review.md](review-guides/zig-src-review.md), [docs-drift-review.md](review-guides/docs-drift-review.md), [scripts-review.md](review-guides/scripts-review.md), and [agentrules-review.md](review-guides/agentrules-review.md) apply here |
