...
| Covers | modelfs daemon (`mount`) and CLI as of `v0.14.0`, peer HTTP protocol, lease discovery, FUSE surface, handover IPC, Hugging Face pull |
...
**Vulnerability handling.** [SECURITY.md](../SECURITY.md) names the supported version (`v0.14.0`
