...
**Vulnerability handling.** [SECURITY.md](../SECURITY.md) names the supported version (`v0.6.0`
is current; the `0.6.x` line receives security fixes) and the route from report to shipped fix.
